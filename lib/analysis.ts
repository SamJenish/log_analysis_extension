...
export function analyzeLog(log: string): AnalysisResult {
  ...
  return {
    ...
    details:
      "The log does not match a built-in failure pattern. Consider forwarding the logs to an AI service for deeper analysis or extend the parser with custom rules.",
  };
}
